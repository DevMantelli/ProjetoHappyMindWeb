<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro-usuario.aspx.cs" Inherits="Happy_Mind.pages.cadastro_usuario" %>
    ...
    <main>
        <form id="formCadUsuario" runat="server">
            ...
            <div class="container--campos">
                ...
                <div class="camposCadUsuario">
                    <asp:Label for="emailUsuario" runat="server">Email: </asp:Label>
                    <asp:TextBox class="txtPequeno" ID="txtEmail" type="text" name="emailUsuario" runat="server"></asp:TextBox>
                </div>
                <div class="camposCadUsuario">
                    <asp:Label for="senhaUsuario" runat="server">Senha: </asp:Label>
                    <asp:TextBox CssClass="txtPequeno" ID="txtSenha" type="text" name="senhaUsuario" runat="server"></asp:TextBox>
                </div>
                <div class="camposCadUsuario">
                    <asp:Label for="nomeUsuario" runat="server">Nome: </asp:Label>
                    <asp:TextBox CssClass="txtPequeno" ID="txtNome" type="text" name="nomeUsuario" runat="server"></asp:TextBox>
                </div>
                <div class="camposCadUsuario">
                    <asp:Label for="telefoneUsuario" runat="server">Telefone: </asp:Label>
                    <asp:TextBox CssClass="txtPequeno" ID="txtTelefone" type="text" name="telefoneUsuario" runat="server"></asp:TextBox>
                </div>
                <div class="camposCadUsuario">
                    <asp:Label for="rgUsuario" runat="server">Rg: </asp:Label>
                    <asp:TextBox CssClass="txtPequeno" ID="txtRg" type="text" name="rgUsuario" runat="server"></asp:TextBox>
                </div>
                <div class="camposCadUsuario">
                    <asp:Label for="nascimentoUsuario" runat="server">Data de Nascimento: </asp:Label>
                    <asp:TextBox CssClass="txtPequeno" ID="txtDtNascimento" type="text" name="nascimentoUsuario" runat="server"></asp:TextBox>
                </div>
            </div>
